...
namespace AtletaAsdericel.Migrations
{
    ...
    [Migration("20250314155603_numeroRegistro_federacao")]
    partial class numeroRegistro_federacao
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AtletaAsdericel.Models.AtletaFederacao", b =>
                {
                    ...
                    b.HasKey("AtletaId", "FederacaoId");

                    b.HasIndex("FederacaoId");

                    b.ToTable("AtletaFederacao");
                });

            modelBuilder.Entity("AtletaAsdericel.Models.AtletaModalidade", b =>
                {
                    b.Property<int>("AtletaId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("AtletaId", "ModalidadeId");

                    b.HasIndex("ModalidadeId");

                    b.ToTable("AtletaModalidade");
                });
            ...
            modelBuilder.Entity("AtletaAsdericel.Models.AtletaFederacao", b =>
                {
                    b.HasOne("AtletaAsdericel.Models.Atleta", "Atleta")
                        .WithMany("AtletaFederacoes")
                        .HasForeignKey("AtletaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AtletaAsdericel.Models.Federacao", "Federacao")
                        .WithMany()
            ...
            modelBuilder.Entity("AtletaAsdericel.Models.Atleta", b =>
                {
                    b.Navigation("AtletaFederacoes");

                    b.Navigation("AtletaModalidades");
                });
