...
namespace AtletaAsdericel.Data
{
	public class ApplicationDbContext : IdentityDbContext<Usuario>
	{
		...
		{
			// Relacionamento N:N entre Atleta e Modalidade
			modelBuilder.Entity<AtletaModalidade>()
				.HasKey(am => new { am.AtletaId, am.ModalidadeId });
			...
			modelBuilder.Entity<AtletaModalidade>()
				.HasOne(am => am.Modalidade)
				.WithMany()
				.HasForeignKey(am => am.ModalidadeId);

			// Relacionamento N:N entre Atleta e Federação
			modelBuilder.Entity<AtletaFederacao>()
				.HasKey(af => new { af.AtletaId, af.FederacaoId });

			modelBuilder.Entity<AtletaFederacao>()
				.HasOne(af => af.Atleta)
				.WithMany(a => a.AtletaFederacoes)
				.HasForeignKey(af => af.AtletaId);

			modelBuilder.Entity<AtletaFederacao>()
				.HasOne(af => af.Federacao)
				.WithMany()
				.HasForeignKey(af => af.FederacaoId);
